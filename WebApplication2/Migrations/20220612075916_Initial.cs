        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Friendships_AspNetUsers_FromUserIdId",
                        column: x => x.FromUserIdId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Friendships_AspNetUsers_ToUserIdId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsPublicMessage = table.Column<bool>(type: "bit", nullable: false),
                    ToGroupIdGroupId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Messages_Groups_ToGroupIdGroupId",
                        column: x => x.ToGroupIdGroupId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Friendships_FromUserIdId",
                table: "Friendships",
                column: "FromUserIdId");

            migrationBuilder.CreateIndex(
                name: "IX_Friendships_ToUserIdId",
                table: "Friendships",
                column: "ToUserIdId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Messages_ToGroupIdGroupId",
                table: "Messages",
                column: "ToGroupIdGroupId");
